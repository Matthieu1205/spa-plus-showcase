...
const serviceCategories = [
  {
    ...
    services: [
      {
        name: "Massage et parcours 9 ou 18 trous/ Massage and 9 or 18 holes course",
        duration: "3h00 min",
        price: "70000 Fcfa",
        description: "Massage et parcours 9 ou 18 trous.",
      },
      {
        name: "Massage spécial golfeurs/Specific massage for Golf players ",
        duration: "1h00 min",
        price: "45000 Fcfa",
        description: "Massage Special Golfeurs.",
      },
      {
        name: "Massage délassant/ Soothing massage",
        duration: "1h00min",
        price: "50000 Fcfa",
        description: "Massage délassant.",
      },
      {
        name: "Massage aromatique/Aromatic massage",
        duration: "1h00 min",
        price: "45000 Fcfa",
        description: "Massage aromatique.",
      },
      {
        name: "Massage relaxant/Relaxing massage",
        duration: "1h00 min",
        price: "40000 Fcfa",
        description: "Massage relaxant.",
      },
      {
        name: "Massage 4 mains/ four hands massage",
        duration: "1h00 min",
        price: "80000 Fcfa",
        description: "Massage 4 mains.",
      },
      {
        name: "Massage tonifiant/Toning massage",
        duration: "1h00 min",
        price: "45000 Fcfa",
        description: "Massage tonifiant.",
      },
      {
        name: "Massage décontractant/Hot stones relaxing massage",
        duration: "1h00 min",
        price: "50000 Fcfa",
        description: "Pierres chaudes.",
      },
      {
        name: "Massage délassant/Hot towel Soothing massage",
        duration: "1h00 min",
        price: "55000 Fcfa",
        description: " serviette chaude.",
      },
      {
        name: "Massage au ballontins/Aromatic bags massage",
        duration: "1h00 min",
        price: "60000 Fcfa",
  ...
  },
  {
    ...
    description: "Gommages et soins du corps.",
    image: massageImage,
    services: [
      {
        name: "Gommage et réhydratation du corps après menstrues/Post menses body scrub and moisturizing",
        duration: "1h00 min",
        price: "45000 FCFA",
        description:
      ...
      {
        name: "Soins traditionnels de Hammam avec Yves Rocher/Hammam traditional care Yves Rocher",
        duration: "1h30mn",
        price: "60000 Fcfa",
        description: "Soins traditionnels de Hammam avec Yves Rocher.",
      },
      {
        name: "Soins traditionnels de Hammam avec Chocolat naturel et la Raskol/Hammam traditional care Raw chocolate & Raskol",
        duration: "2h00mn",
        price: "80000 FcFA",
        description:
      ...
      {
        name: "Soins traditionnels de Hammam avec Henné naturel et la Raskol/Hammam traditional care Raw henna & Raskol",
        duration: "2h00mn",
        price: "70000 fcfa",
        description:
          "Soins traditionnels de Hammam avec Henné naturel et la Raskol.",
      },
    ],
  },
  ...
  },
  {
    ...
    services: [
      ...
      {
        name: "Extension cils / Extension cils",
        duration: "1h00min",
        price: "80000 Fcfa",
      },
    ],
  },
  {
    ...
    services: [
      ...
      {
        name: "Forfait de 10 séances / 10 session's package",
        duration: "10h00min",
        price: "400000 Fcfa",
      },
    ],
  },
  {
    ...
    services: [
      ...
      {
        name: "Vajacial + Maillot/ Vajacial + Bikini-line",
        duration: "35 min",
        price: "10000 Fcfa",
      },
      {
      ...
      {
        name: "Lèvre supérieur / Upper Lips",
        duration: "15 min",
        price: "20000 Fcfa",
      },
      {
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        duration: "45 min",
        price: "25000 Fcfa - 30000 Fcfa",
      },
      {
        name: "Pose cils",
        duration: "45 min",
        price: "15000 Fcfa - 10000 Fcfa",
      },
      {
      ...
      {
        name: "Mycro blending / Mycro blending",
        duration: "1h00 min",
        price: "80000 Fcfa",
      },
      {
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        name: "Tresse / Braid",
        duration: "45 min",
        price: "15000 Fcfa-60000 Fcfa",
      },
      {
        name: "Tissage / Weaving",
        duration: "45 min",
        price: "15000 Fcfa-25000 Fcfa",
      },
      {
        name: "Rajout sans défrisage",
        duration: "45 min",
        price: "10000 Fcfa-15000 Fcfa",
      },
      {
        name: "Rajout avec défrisage",
        duration: "45 min",
        price: "25000 Fcfa-30000 Fcfa",
      },
    ],
